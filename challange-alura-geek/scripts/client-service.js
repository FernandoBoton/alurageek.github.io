//Conexion
const listaProductos = () => fetch('https://ecommerce-fernando.herokuapp.com/productos').then(respuesta => respuesta.json());

const crearProducto = (nombre, precio, imagen, categoria, descripcion) => {
  return fetch('https://ecommerce-fernando.herokuapp.com/productos', {
    method: "POST",
    headers: {
...
const eliminarProducto = (id) => {
  return fetch(`https://ecommerce-fernando.herokuapp.com/productos/${id}`, {
    method: "DELETE"
  });
};
...
const detalleProducto = async (id) => {
  return fetch(`https://ecommerce-fernando.herokuapp.com/productos/${id}`).then( respuesta => respuesta.json());
};
